Ext.define('WeighbridgeOrder.store.HaulierVehicleAssignedStore', {
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            ...
            remoteSort: true,
            storeId: 'HaulierVehicleAssignedStore',
            proxy: {
                type: 'ajax',
                actionMethods: {
                    read: 'POST'
                ...
                batchActions: false,
                api: {
                    read: Utils.serverUrl+'data/service.php?Service=WeighbridgeOrderHaulierVehicles_Assigned'
                },
                extraParams: {
